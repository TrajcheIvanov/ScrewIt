...
namespace ScrewIt.Repositories.Migrations
{
    ...
    [Migration("20210920172833_updateReceiptsModel")]
    partial class updateReceiptsModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScrewIt.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ScrewIt.Models.Receipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("TotalForPayment")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ScrewIt.Models.ReceiptItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ScrewIt.Models.Order", b =>
                {
                    b.HasOne("ScrewIt.Models.Panel", "Panel")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ScrewIt.Models.Receipt", b =>
                {
                    b.HasOne("ScrewIt.Models.ApplicationUser", "Emplyee")
                        .WithMany()
